...
def main():
    ...
    for i in data['การใช้']:
        datahead.append(i)
    bar_chart = pygal.Bar(title = 'จำนวนผู้ใช้งาน คอมพิวเตอร์ อินเทอร์เน็ต และ โทรศัพท์มือถือ(คน) 1:1000')
    ...
    bar_chart.render_to_file("2.Use_Graph.svg")
main()
